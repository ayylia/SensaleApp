    ...
    <div style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center', background: '#F8F9FA', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="animate-fade-in-up" style={{ width: '100%', maxWidth: '440px', padding: '48px', background: '#ffffff', borderRadius: '32px', boxShadow: '0 20px 40px rgba(0,0,0,0.04), 0 1px 3px rgba(0,0,0,0.05)', position: 'relative', zIndex: 10, border: '1px solid #E5E7EB' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#1F2937', margin: '0 0 8px', letterSpacing: '-0.5px' }}>Welcome back</h2>
          <p style={{ fontSize: '15px', color: '#6B7280', margin: 0, fontWeight: 500 }}>Sign in to access your intelligent dashboard</p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
               <label style={{ display: 'block', fontSize: '13px', fontWeight: 700, color: '#374151', textTransform: 'uppercase', letterSpacing: '1px' }}>
                 Password
               </label>
            </div>
            <input
        ...
        <p style={{ marginTop: '32px', textAlign: 'center', fontSize: '15px', color: '#6B7280', fontWeight: 500 }}>
          New to Sensale?{" "}
          <Link to="/signup" style={{ color: '#B00058', fontWeight: 700, textDecoration: 'none' }}>
            Create an account
          </Link>
        </p>
      </div>
